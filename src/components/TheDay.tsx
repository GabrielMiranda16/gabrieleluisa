        ...
        >
          ...
          <div style={{ padding: 'clamp(2.5rem, 6vw, 4rem)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 28, textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
              <span style={{ fontFamily: 'Montserrat', fontSize: '0.65rem', letterSpacing: '0.4em', textTransform: 'uppercase', color: '#6B7563', fontWeight: 500 }}>
                Cerimônia & Recepção
              </span>
              <h3 style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(2rem, 5vw, 3rem)', fontWeight: 500, color: '#2D4A3E', letterSpacing: '0.03em' }}>
                Maison Reserva
              </h3>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6 }}>
              <p style={{ fontFamily: 'Cormorant Garamond, serif', fontSize: 'clamp(1.2rem, 3vw, 1.6rem)', color: '#2D4A3E', fontStyle: 'italic', fontWeight: 400 }}>
                21 de Abril de 2027
              </p>
              <p style={{ fontFamily: 'Montserrat', fontSize: '0.8rem', letterSpacing: '0.25em', color: '#6B7563', fontWeight: 400 }}>
                16H00
              </p>
            </div>
          ...
          {/* Botão */}
          <div style={{ padding: '2.5rem', display: 'flex', justifyContent: 'center', borderTop: '1px solid #D4E6DC' }}>
            <a
            ...
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#2D4A3E" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
