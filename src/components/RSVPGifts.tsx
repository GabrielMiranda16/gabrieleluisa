...
export default function RSVPGifts() {
  return (
    <>
      ...
      <section style={{ background: '#2D4A3E', padding: '6rem 1.5rem', minHeight: '100vh', display: 'flex', alignItems: 'center' }}>
        <motion.div
        ...
        >
          <div style={{ width: 72, height: 72, borderRadius: '50%', background: 'rgba(245,240,234,0.1)', border: '1px solid rgba(201,168,108,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <svg width="36" height="36" viewBox="0 0 32 32" fill="none">
              <path d="M16 10V28M8 10h16M6 10h20v4H6z" stroke="rgba(245,240,234,0.7)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              <path d="M10 14v14h12V14" stroke="rgba(245,240,234,0.7)" strokeWidth="1.5" strokeLinecap="round"/>
